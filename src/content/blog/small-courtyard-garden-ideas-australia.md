...
tags: ["small courtyard garden ideas Australia", "courtyard garden australia", "small backyard garden australia", "terrace house garden", "narrow courtyard ideas"]
category: "Outdoor Entertaining"
featured: false
readTime: "9 min read"
tldr:
  - "Vertical planting is the single biggest space-saver in a small courtyard — wall-mounted planters free up the entire floor for seating."
  - "Raised garden beds outperform in-ground planting in courtyards with poor drainage or compacted soil, common in older terrace houses."
  - "Pale paving or gravel reflects light and makes a shaded courtyard feel noticeably brighter."
  - "A single well-chosen feature tree in a large pot does more for the space than a dozen small pots scattered around."
  - "Reflective surfaces — a mirror or glossy-tiled wall — genuinely make a narrow courtyard feel wider."
faqs:
  - q: "What plants work best in a small shaded Australian courtyard?"
    a: "Native shade-tolerant options like Lomandra, Clivia, and tree ferns handle low light well across most Australian climates. Birds Nest Fern and Kentia Palm both thrive in the dappled light common in terrace-house courtyards. Avoid full-sun natives like Grevillea or Banksia in a courtyard that gets less than 4 hours of direct sun — they'll struggle and look leggy within a season."
  - q: "How do I stop a small courtyard garden from looking cluttered?"
    a: "Stick to a maximum of three plant varieties and repeat them rather than adding one of everything. Use matching pots — even mismatched terracotta in three sizes reads as intentional, while five different colours and materials reads as chaotic. Keep the floor mostly clear; group pots against walls rather than scattering them through the walking space."
  - q: "Can I have a garden in a fully paved courtyard?"
    a: "Yes — this is actually the norm for older Australian terrace houses. Raised planter boxes (Bunnings sells modular ones from $79) sit directly on pavers with no digging required. A mix of large floor planters and wall-mounted vertical planters gives you a full garden without touching the existing paving, which also avoids drainage and root-damage issues in a small enclosed space."
  - q: "How much does a small courtyard garden renovation cost in Australia?"
    a: "A modest DIY refresh — pots, plants, a vertical planter, and some string lighting — typically runs $400–$900 AUD. A fuller renovation including new paving or decking, a water feature, and established plants can range from $3,000–$8,000 AUD depending on the trade work involved. Vertical greening and pot gardens are the best value upgrades if the budget is tight."
---

Our Sydney terrace has a courtyard that's 3.2m by 4m — barely bigger than a double garage, and for the first year we owned the house, it was where the bins lived and nothing else. It gets decent morning light but goes into shade by early afternoon thanks to a two-storey wall on the western side. Here's what actually worked to turn it into a space we use most evenings.
...
|----------|--------|--------------|
| 1 | Resurface or lighten the existing ground with pale pavers or gravel | ~$8–$42/sqm |
| 2 | Install vertical planters and one feature tree | ~$300–$500 AUD |
| 3 | Add raised beds if soil/drainage is poor | ~$250–$400 AUD |
| 4 | Set up compact, wall-mounted or fold-away furniture | ~$100–$250 AUD |
| 5 | Add festoon lighting and a mirror for depth | ~$150–$250 AUD |

---

**Related reading:**
- [Backyard Landscaping Ideas for Australian Homes](/blog/backyard-landscaping-ideas-australia)
- [Native Garden Ideas for Australian Backyards](/blog/native-garden-ideas-australia)
